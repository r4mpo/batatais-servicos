...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O :attribute informado apareceu em um vazamento de dados. Escolha um diferente.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui você pode substituir os nomes técnicos dos atributos pelos nomes
    | amigáveis exibidos ao usuário final.
    |
    */
